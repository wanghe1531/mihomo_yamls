...
#### 📝 mihomoconfig.yaml
- **路径**: `AIsouler/mihomoconfig.yaml` | **大小**: 23.4 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/AIsouler/mihomoconfig.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
- **路径**: `AIsouler/mihomoConfigLite.yaml` | **大小**: 15.6 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/AIsouler/mihomoConfigLite.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
- **路径**: `Pililink/2-subscription-clash-rule-set.yaml` | **大小**: 15.8 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/Pililink/2-subscription-clash-rule-set.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: 🚫
<details>
<summary>🔍 策略组 (37个)</summary>
...
- **路径**: `Pililink/base-clash-ruleset.yaml` | **大小**: 13.8 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/Pililink/base-clash-ruleset.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: 🚫
<details>
<summary>🔍 策略组 (27个)</summary>
...
- **路径**: `Pililink/3-subscription-clash-rule-set.yaml` | **大小**: 16.3 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/Pililink/3-subscription-clash-rule-set.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: 🚫
<details>
...
- **路径**: `Seven1echo/Seven1_fallback_Rule-Set.yaml` | **大小**: 24.0 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/Seven1echo/Seven1_fallback_Rule-Set.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
<summary>🔍 策略组 (43个)</summary>
...
#### 📝 Proxy-override.yaml
- **路径**: `Sgraqwq/Proxy-override.yaml` | **大小**: 21.6 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/Sgraqwq/Proxy-override.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: 🚫
<details>
...
#### 📝 mihomo.yaml
- **路径**: `Tangerinell/mihomo.yaml` | **大小**: 44.4 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/Tangerinell/mihomo.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
#### 📝 mihomo.yaml
- **路径**: `XVSVTSAMA/mihomo.yaml` | **大小**: 18.1 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/XVSVTSAMA/mihomo.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
#### 📝 mihomo.yaml
- **路径**: `ameyukisora/mihomo.yaml` | **大小**: 5.8 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/ameyukisora/mihomo.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: 🚫
<details>
<summary>🔍 策略组 (9个)</summary>
...
#### 📝 mihomo.yaml
- **路径**: `loneshu7/mihomo.yaml` | **大小**: 30.4 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/loneshu7/mihomo.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: 🚫
<details>
...
#### 📝 config.yaml
- **路径**: `wanswu/config.yaml` | **大小**: 23.4 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/wanswu/config.yaml)
- **模式**: rule | **TUN**: 🚫 | **IPv6**: 🚫
<details>
