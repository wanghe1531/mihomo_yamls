...
#### 📝 mihomo.yaml
- **路径**: `echs-top/mihomo.yaml` | **大小**: 13.1 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/echs-top/mihomo.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
#### 📝 config.yaml
- **路径**: `wanswu/config.yaml` | **大小**: 32.7 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/General_Config/wanswu/config.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
