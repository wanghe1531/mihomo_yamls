...
#### 📝 config.yaml
- **路径**: `ClashMix/config.yaml` | **大小**: 6.5 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/Mobile_Modules/ClashMix/config.yaml)
- **模式**: rule | **TUN**: ✅ | **IPv6**: ✅
<details>
...
#### 📝 config.yaml
- **路径**: `Surfing/config.yaml` | **大小**: 19.1 KB | [查看源码](https://github.com/wanghe1531/mihomo_yamls/blob/main/THEYAMLS/Mobile_Modules/Surfing/config.yaml)
- **模式**: Rule | **TUN**: 🚫 | **IPv6**: ✅
<details>
